...
router.put('/settings', (req, res) => {
  try {
    const db = getDb();
    const { name, type, owner_name, phone, address, city, description, logo_url, brand_color, buffer_minutes, cancellation_hours, terms_text, bot_tone, green_invoice_api_key, green_invoice_enabled, hide_stats } = req.body;
